                                        ...
                                        {if pathinfo($attachment.file_name, PATHINFO_EXTENSION) === 'mp3'}
                                            <div class="product-mp3-stream">
                                                ...
                                                style="display:flex; align-items: center;
                                                  justify-content: space-around; margin-top: 0.2em;
                                                  margin-bottom: 0.2em; margin-left:24%; margin-right:24%;
                                                  border-style: outset; border-color: coral; background-color: coral">
                                                    <span></span>
                                                    <span></span>
                                                    ...
                                                    <span class="timespan" id="timespan{$product.id_product}" style="font-size: 1.6em;">0:00 / 0:00</span>
                                                    <span></span>
                                                    <span></span>
                                                </div>
                                            </div>
